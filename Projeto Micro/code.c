...
int main ( int argc, char ** argv )
{
  ...
  Instruction instructions[] = { 
    ...
    { .label = "&&" , .binaryCode = 0b00000101, .qtdParans = 2 },
    { .label = "||" , .binaryCode = 0b00000110, .qtdParans = 2 },
    { .label = "XOR", .binaryCode = 0b00000111, .qtdParans = 2 },
    { .label = "~"  , .binaryCode = 0b00001000, .qtdParans = 1 },
    { .label = ">"  , .binaryCode = 0b00001001, .qtdParans = 2 },
    { .label = ">=" , .binaryCode = 0b00001010, .qtdParans = 2 },
    { .label = "<"  , .binaryCode = 0b00001011, .qtdParans = 2 },
    { .label = "<=" , .binaryCode = 0b00001100, .qtdParans = 2 },
    { .label = "==" , .binaryCode = 0b00001101, .qtdParans = 2 },
    { .label = "!=" , .binaryCode = 0b00001110, .qtdParans = 2 },
  };
